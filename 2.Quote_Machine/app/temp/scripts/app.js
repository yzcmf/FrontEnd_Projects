...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MashapeApi = __webpack_require__(2);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var mashapeApi = (0, _MashapeApi.mashape)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mashape() {
	  ...
	  (0, _jquery2.default)('a.btn').on("click", function () {
	    createQuote();
	  });

	  function createQuote() {
	    // The following is the API call to the MashApe random quotes API server
	    var output = _jquery2.default.ajax({
	      ...
	      error: function error(err) {
	        ...
	        (0, _jquery2.default)('#quote').html(quotes[randomQuoteNumber][0]);
	        (0, _jquery2.default)('#author').html(quotes[randomQuoteNumber][1]);
	      },
